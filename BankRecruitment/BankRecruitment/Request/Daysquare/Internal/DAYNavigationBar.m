...
- (void)commonInit {
    ...
    self.textLabel.textColor = [UIColor colorWithHex:@"#8792ae"];
    ...
    [self.prevButton setImage:[[UIImage imageNamed:@"calendar_btn_arrow_left"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateNormal];
    ...
    [self.nextButton setImage:[[UIImage imageNamed:@"calendar_btn_arrow_right"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateNormal];
