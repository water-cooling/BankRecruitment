...
//    NSLog(@"current thread in drawInContext %@",[NSThread currentThread]);
        ...
        if ([self.titleText length] == 0)
        {
            ...
            CGRect labelFrame = CGRectMake(self.width/2-labelSize.width/2, centerY-labelSize.height/2, labelSize.width, labelSize.height);
            CGRect maskFrame = CGRectMake(self.width/2-maskSize.width/2, centerY-maskSize.height/2, maskSize.width, maskSize.height);
        ...
        else
        {
            ...
            CGRect maskFrame = CGRectMake(self.width/2-maskSize.width/2, centerY-maskSize.height/2, maskSize.width, maskSize.height);
            CGRect titleFrame = CGRectMake(self.width/2-titleSize.width/2, maskFrame.origin.y+13, titleSize.width, titleSize.height);
            CGRect labelFrame = CGRectMake(self.width/2-labelSize.width/2, CGRectGetMaxY(titleFrame)+5, labelSize.width, labelSize.height);
